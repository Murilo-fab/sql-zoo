...
SELECT constituency,party
 ...
 WHERE constituency BETWEEN 'S14000021' AND 'S14000026'
   AND yr  = 2017
   AND votes > ALL
   (SELECT votes FROM ge y WHERE y.constituency=x.constituency AND y.party!=x.party AND yr = 2017)
...
SELECT party, COUNT(constituency)
 ...
 WHERE constituency LIKE 'S%'
   AND yr  = 2017
   AND votes >= ALL(SELECT votes FROM ge y WHERE y.constituency=x.constituency AND yr=2017)
GROUP BY party